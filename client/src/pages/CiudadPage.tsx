            ...
            return (
              ...
              >
                <Link href={`/${cat.slug}/${ciu.slug}/${barrio.slug}`}>
                  <div className="group bg-card border border-border/60 shadow-sm hover:shadow-lg rounded-xl p-5 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
